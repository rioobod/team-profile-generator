...
// import functions to generate the html and write the file.
const generateTeamPage = require("../utils/Page-Template-Generator");
...
class Team {
  ...
  // this function will generate the members and then then html data.
  initializeTeam() {
    this.getManager()
      .then((manager) => {
      ...
      .then((team) => {
        ...
        this.teamMembers.push(...team.members);
      ...
      .then((teamMembers) => {
        // console.log(team)
        return generateTeamPage(teamMembers);
      })
      .then((htmlPage) => writeFile(htmlPage))
      .then((createStyle) => copyFile(createStyle));
  }
}
